...
// which is what a player writes when the network carries more devices than the
// housing has pins for. It keeps no array and no global, so every value it
// carries across a turn lives in a register and the data region stays empty.
